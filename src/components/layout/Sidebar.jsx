...
export default function Sidebar({
  isOpen, locations, selected, likedIds, searchInput, filterType, filterRisk,
    ...
    <>
      ...
      <div style={containerStyle}>
        ...
        <div style={{ padding: "16px 14px 12px", borderBottom: "1px solid #1a1a1a", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          {isMobile && (
            <button onClick={onCloseSidebar} style={{
        ...
        <div style={{ padding: "10px 12px", borderTop: "1px solid #1a1a1a", flexShrink: 0 }}>
          <button onClick={onShowUpload} className="btn-hover" style={{
            width: "100%", background: "#c8b89a", color: "#0a0a0a",
